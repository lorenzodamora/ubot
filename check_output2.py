...
print("Ubot2: script check_output.py partito")
push = pb.push_note("Ubot2", " script check_output.py partito")
try:
    while True:
        ...
        if current_modified_time != last_modified_time:
            ...
            push = pb.push_note("Ubot2", " ha mandato testo in terminale. apri il file output.txt")
    ...
    print("Ubot2: script check_output.py stoppato")
    push = pb.push_note("Ubot2", " script check_output.py stoppato")
